...
class BertRankerTrainer(training.Trainer):
    def __init__(self):
        super(BertRankerTrainer, self).__init__(BertRanker, specific)

    def update_config(self, args):
        super(BertRankerTrainer, self).update_config(args)
        pass
    ...
    def create_parser(model_name):
        ...
        group = parser['files']
        group.add_argument('--pre_trained_model', '--pre', '-P', type=str, help='Path to the pre-trained BERT model to load initially')
        return parser
