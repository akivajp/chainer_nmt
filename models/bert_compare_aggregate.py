...
class BertCompareAggregate(chainer.Chain):
    def __init__(self, vocab, **params):
        ...
        #super(BertCompareAggregate, self).__init__()
        ...
        with self.init_scope():
            self.L_bert = Bert(vocab = vocab, **params)
            #self.L_classify = L.Linear(embed_size, num_classes, initialW=linear_init)
            self.L_ca = CompareAggregate(vocab = vocab, **params)
